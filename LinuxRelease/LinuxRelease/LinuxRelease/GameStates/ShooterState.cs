...
namespace SpaceProject
{
    public class ShooterState : GameState
    {
        ...
        public static Dictionary<String, LevelEntry> GetMissionPathDict()
        {
            ...
            entryDict.Add("1_1", new LevelEntry("RebelsInTheMeteors",   "mainlevels/m1_rebels_asteroids",       MissionType.regularalliance));
            entryDict.Add("2_1", new LevelEntry("FreighterEscort1",     "mainlevels/m2_freighter_escort_lv_1",  MissionType.regularalliance));
            entryDict.Add("2_2", new LevelEntry("FreighterEscort2",     "mainlevels/m2_freighter_escort_lv_2",  MissionType.regularalliance));
            entryDict.Add("3_1", new LevelEntry("DefendColonyBreak",    "mainlevels/m3_defend_colony_lv_1",     MissionType.power));
            entryDict.Add("3_2", new LevelEntry("DefendColonyHold",     "mainlevels/m3_defend_colony_lv_2",     MissionType.power));

            entryDict.Add("4_1", new LevelEntry("Infiltration1",        "mainlevels/m4_infiltration_lv_1",      MissionType.dark));
            entryDict.Add("4_2", new LevelEntry("Infiltration2",        "mainlevels/m4_infiltration_lv_2",      MissionType.dark));
            entryDict.Add("5_1", new LevelEntry("Retribution1",         "mainlevels/m5_retribution_lv_1",       MissionType.regularrebel));
            entryDict.Add("5_2", new LevelEntry("Retribution2",         "mainlevels/m5_retribution_lv_2",       MissionType.regularrebel));
            entryDict.Add("6_1", new LevelEntry("Itnos_1",              "mainlevels/m6_itnos_lv_1",             MissionType.regularrebel));
            entryDict.Add("6_2", new LevelEntry("Itnos_2",              "mainlevels/m6_itnos_lv_2",             MissionType.regularrebel));
            entryDict.Add("7_1", new LevelEntry("Information",          "mainlevels/m7_information",            MissionType.dark));

            entryDict.Add("8o_1", new LevelEntry("OnYourOwn_1",         "mainlevels/m8a_oyo_lv_1",              MissionType.goingout));
            entryDict.Add("8o_2", new LevelEntry("OnYourOwn_2",         "mainlevels/m8a_oyo_lv_2",              MissionType.goingout));
            entryDict.Add("8r_1", new LevelEntry("RebelBranch_1",       "mainlevels/m8b_rebels_lv_1",           MissionType.regularrebel));
            entryDict.Add("8r_2", new LevelEntry("RebelBranch_2",       "mainlevels/m8b_rebels_lv_2",           MissionType.regularrebel));
            entryDict.Add("8a_1", new LevelEntry("AllianceBranch_1",    "mainlevels/m8c_alliance_lv_1",         MissionType.regularrebel));
            entryDict.Add("8a_2", new LevelEntry("AllianceBranch_2",    "mainlevels/m8c_alliance_lv_2",         MissionType.regularrebel));

            // Side

            entryDict.Add("s_flightTraining_1", new LevelEntry("flightTraining_1", "sidelevels/flight_training_1_1",   MissionType.regularalliance));
            entryDict.Add("s_flightTraining_2", new LevelEntry("flightTraining_2", "sidelevels/flight_training_1_2",   MissionType.regularalliance));
            entryDict.Add("s_flightTraining_3", new LevelEntry("flightTraining_3", "sidelevels/flight_training_1_3",   MissionType.regularalliance));

            entryDict.Add("s_ft2_1", new LevelEntry("ft2_1", "sidelevels/ft2/ft2_collision",            MissionType.regularalliance));
            entryDict.Add("s_ft2_2", new LevelEntry("ft2_2", "sidelevels/ft2/ft2_under_fire",           MissionType.regularalliance));
            entryDict.Add("s_ft2_3", new LevelEntry("ft2_3", "sidelevels/ft2/ft2_break_the_defence",    MissionType.regularalliance));
            ...
            entryDict.Add("s_deathByMeteor",    new LevelEntry("DeathByMeteor",    "sidelevels/death_by_meteor",        MissionType.regularrebel));
            entryDict.Add("s_astroScan",        new LevelEntry("AstroScan",        "sidelevels/astro_scan",             MissionType.dark));
            entryDict.Add("s_astroDodger",      new LevelEntry("AstroDodger",      "sidelevels/astro_dodger",           MissionType.dark));
            entryDict.Add("s_theRebelOutpost_1", new LevelEntry("theRebelOutpost_1", "sidelevels/the_rebel_outpost_1",  MissionType.dark));
            entryDict.Add("s_theRebelOutpost_2", new LevelEntry("theRebelOutpost_2", "sidelevels/the_rebel_outpost_2",  MissionType.dark));


            // Pirates

            entryDict.Add("rp1", new LevelEntry("RebelPirate1",     "pirates/rebel_pirate_1",     MissionType.rebelpirate));
            entryDict.Add("rp2", new LevelEntry("RebelPirate2",     "pirates/rebel_pirate_2",     MissionType.rebelpirate));
            entryDict.Add("rp3", new LevelEntry("RebelPirate3",     "pirates/rebel_pirate_3",     MissionType.rebelpirate));
            entryDict.Add("rp4", new LevelEntry("RebelPirate4",     "pirates/rebel_pirate_4",     MissionType.rebelpirate));
            entryDict.Add("rp5", new LevelEntry("RebelPirate5",     "pirates/rebel_pirate_5",     MissionType.rebelpirate));

            entryDict.Add("ap1", new LevelEntry("AlliancePirate1",  "pirates/alliance_pirate_1",  MissionType.alliancepirate));
            entryDict.Add("ap2", new LevelEntry("AlliancePirate2",  "pirates/alliance_pirate_2",  MissionType.alliancepirate));
            entryDict.Add("ap3", new LevelEntry("AlliancePirate3",  "pirates/alliance_pirate_3",  MissionType.alliancepirate));
            entryDict.Add("ap4", new LevelEntry("AlliancePirate4",  "pirates/alliance_pirate_4",  MissionType.alliancepirate));
            entryDict.Add("ap5", new LevelEntry("AlliancePirate5",  "pirates/alliance_pirate_5",  MissionType.alliancepirate));

            entryDict.Add("hangar1", new LevelEntry("hangar1",      "pirates/hangar_1",           MissionType.alliancepirate));
            entryDict.Add("hangar2", new LevelEntry("hangar2",      "pirates/hangar_2",           MissionType.alliancepirate));
            entryDict.Add("hangar3", new LevelEntry("hangar3",      "pirates/hangar_3",           MissionType.alliancepirate));

            // Sub

            entryDict.Add("sub1", new LevelEntry("sub1", "sublevels/rebel_ambush_sub_1", MissionType.rebelpirate));
