...
{
    public class DrillBeam : PlayerBullet
    {
        #region decl
        float posX;
        float startY;
        float endY;
        #endregion
        public DrillBeam(Game1 Game, Sprite spriteSheet) :
        ...
        public override void Initialize()
        {
            ...
            anim.LoopTime = 300;
            anim.AddFrame(spriteSheet.GetSubSprite(new Rectangle(18, 27, 4, 1)));
            
            Bounding = new Rectangle(18, 27, 4, 1);
