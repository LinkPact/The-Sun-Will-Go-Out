...
namespace SpaceProject
{
    public class Side_FlightTraining2 : Mission
    {
        ...
        protected override void SetDestinations()
        {
            ...
            AddDestination(trainingArea2, 7);
        }
        ...
        protected override void SetupObjectives()
        {
            ...
            objectives.Add(new ShootingLevelObjective(Game, this, ObjectiveDescriptions[0],
                "ft_collision", LevelStartCondition.TextCleared,
            ...
            objectives.Add(new ShootingLevelObjective(Game, this, ObjectiveDescriptions[0],
                "ft_underfire", LevelStartCondition.TextCleared,
            ...
            objectives.Add(new ShootingLevelObjective(Game, this, ObjectiveDescriptions[0],
                "RebelsInTheMeteors", LevelStartCondition.TextCleared));
        }
    }
}
