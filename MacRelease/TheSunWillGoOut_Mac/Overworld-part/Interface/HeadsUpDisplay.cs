    ...
    public class HeadsUpDisplay
    {
        ...
        private void DrawPosition(SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.DrawString(game.fontManager.GetFont(14),
               "(X: " + ((int)(game.player.position.X / 10) - origo.X / 10) + ",Y: " +
                ...
                new Vector2(game.camera.cameraPos.X + Game1.ScreenSize.X / 2 - 101,
                           game.camera.cameraPos.Y + Game1.ScreenSize.Y / 2 - 221) + game.fontManager.FontOffset,
                Color.Red, 0f,
        ...
        private void DrawFusionCells(SpriteBatch spriteBatch)
        {
            spriteBatch.DrawString(game.fontManager.GetFont(14), "Fusion Cells: ",
                new Vector2(game.camera.cameraPos.X - Game1.ScreenSize.X / 2 + 8,
                game.camera.cameraPos.Y + Game1.ScreenSize.Y / 2 - 97) +
        ...
        private void DrawRepAndProgress(SpriteBatch spriteBatch)
        {
            spriteBatch.DrawString(game.fontManager.GetFont(14), "Reputation: " + StatsManager.reputation,
                new Vector2(game.camera.cameraPos.X - Game1.ScreenSize.X / 2 + 8,
                    game.camera.cameraPos.Y - Game1.ScreenSize.Y / 2 + 8) +
                    game.fontManager.FontOffset,
                game.fontManager.FontColor, .0f, Vector2.Zero, 1f, SpriteEffects.None, 0.92f);

            spriteBatch.DrawString(game.fontManager.GetFont(14), "Progress: " + StatsManager.progress,
                new Vector2(game.camera.cameraPos.X - Game1.ScreenSize.X / 2 + 8,
                    game.camera.cameraPos.Y - Game1.ScreenSize.Y / 2 + 24) +
                    game.fontManager.FontOffset,
                game.fontManager.FontColor, .0f, Vector2.Zero, 1f, SpriteEffects.None, 0.92f);
        }
        ...
        private void DrawMenuInfo(SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.DrawString(game.fontManager.GetFont(12), "Press '" + ControlManager.GetKeyName(RebindableKeys.Pause) +"' to open menu",
                new Vector2(game.camera.cameraPos.X - Game1.ScreenSize.X / 2 + 8,
                    game.camera.cameraPos.Y - Game1.ScreenSize.Y / 2 + 40) +
                    game.fontManager.FontOffset,
                game.fontManager.FontColor, .0f, Vector2.Zero, 1f, SpriteEffects.None, 0.92f);
            ...
            spriteBatch.DrawString(game.fontManager.GetFont(12), "Press '" + ControlManager.GetKeyName(RebindableKeys.Map) + "' to show map",
                new Vector2(game.camera.cameraPos.X - Game1.ScreenSize.X / 2 + 8,
                    game.camera.cameraPos.Y - Game1.ScreenSize.Y / 2 + 80) +
                    game.fontManager.FontOffset,
                game.fontManager.FontColor, .0f, Vector2.Zero, 1f, SpriteEffects.None, 0.92f);
            ...
            spriteBatch.DrawString(game.fontManager.GetFont(12), "Press '" + ControlManager.GetKeyName(RebindableKeys.Missions) + "' to open mission log",
                new Vector2(game.camera.cameraPos.X - Game1.ScreenSize.X / 2 + 8,
                    game.camera.cameraPos.Y - Game1.ScreenSize.Y / 2 + 100) +
                    game.fontManager.FontOffset,
                game.fontManager.FontColor, .0f, Vector2.Zero, 1f, SpriteEffects.None, 0.92f);
        }
    }
