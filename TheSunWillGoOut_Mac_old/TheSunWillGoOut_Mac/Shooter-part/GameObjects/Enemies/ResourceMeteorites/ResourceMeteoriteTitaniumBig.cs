...
{
    class ResourceMeteoriteTitaniumBig : ResourceMeteorite
    {
        ...
        public override void Initialize()
        {
            ...
            ObjectName = "ResourceMeteoriteTitaniumBig";

            anim.LoopTime = 1;
            anim.AddFrame(spriteSheet.GetSubSprite(new Rectangle(0, 105, 30, 30)));
